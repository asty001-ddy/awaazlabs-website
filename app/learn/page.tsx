  ...
  return (
    <>
      ...
      <div className="mx-auto grid max-w-[1200px] gap-5 px-5 pb-20 md:grid-cols-2 lg:px-8">
        <Link
          href="/learn/missed-call-statistics"
          className="card card-lift group flex flex-col p-7 md:col-span-2"
        >
          <p className="label text-signal">Reference</p>
          <h2 className="mt-3 font-display text-2xl leading-snug font-medium tracking-tight text-ink">
            Missed Call Statistics: How Many Calls Do Businesses Miss?
          </h2>
          <p className="mt-2 text-[15px] leading-relaxed text-ink-soft">
            The benchmark numbers, sourced and framed: 23 to 42 percent of
            calls missed, 78 percent of after-hours callers gone without a
            voicemail.
          </p>

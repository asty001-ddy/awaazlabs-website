...
/*
 * DRAFT: requires Advanzatech sign-off on final copy before the
 * production deploy (master-build-v5, decision log). All figures are
 * from the approved proof list.
 */

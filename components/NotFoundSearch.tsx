...
const DESTINATIONS = [
  ...
  { label: "Dental clinics", href: "/industries/dental", terms: "dental dentist teeth clinic" },
  { label: "Restaurants", href: "/industries/restaurants", terms: "restaurant reservations tables" },
  { label: "Home services", href: "/industries/home-services", terms: "home services trades plumber" },
